...
public class AddSupportersPinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_supporters_pin);

        foreword_arrow=findViewById(R.id.foreword_arrow);

        foreword_arrow.setOnClickListener(v -> {
                    startActivity(new Intent(AddSupportersPinActivity.this, StartSupporterActivity.class));
                }
        );
